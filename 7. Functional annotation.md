...
apptainer run --bind /fs/ess/scratch/PAS2303/Juan/Annotation/Funannotate_pipeline/data/database:/data/database /fs/ess/scratch/PAS2303/Juan/Annotation/Software/Funannotate.sif funannotate iprscan -i Peltaster_fructicola -m local -c 28 --iprscan_path /fs/ess/scratch/PAS2303/Juan/Annotation/Funannotate_pipeline/interproscan-5.59-91.0
EOF
```
Then, we send it to the scheduler:
```
...
apptainer run /fs/ess/scratch/PAS2303/Juan/Annotation/Software/Funannotate.sif funannotate remote -m phobius -e your_osu_email@osu.edu -i Peltaster_fructicola
EOF
```
Then, we send it to the scheduler:
```
...
# Working directory
cd /fs/ess/scratch/PAS2303/Juan/Annotation/Annotation/Funannotate/Functional_annotation
# Running functional annotation
apptainer run --bind /fs/ess/scratch/PAS2303/Juan/Annotation/Funannotate_pipeline/data/database:/data/database /fs/ess/scratch/PAS2303/Juan/Annotation/Software/Funannotate.sif funannotate annotate -i /fs/ess/scratch/PAS2303/Juan/Annotation/Funannotate_pipeline/Peltaster_fructicola --busco_db dothideomycetes_odb10 --cpus 28 --force
EOF
```
Then, we send it to the scheduler:
```
