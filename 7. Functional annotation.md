...
apptainer run --bind /fs/ess/scratch/PAS2303/Juan/Annotation/Funannotate_pipeline/data/database:/data/database /fs/ess/scratch/PAS2303/Juan/Annotation/Software/Funannotate.sif funannotate annotate -i Peltaster_fructicola --busco_db dothideomycetes_odb10 --cpus 28 --force 
EOF
```
Then, we send it to the scheduler:
```
