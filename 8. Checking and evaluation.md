...
# Transcripts
apptainer exec /fs/ess/scratch/PAS2303/Juan/Annotation/Software/BUSCO.sif busco -i transcripts.fa -o Transcripts --mode transcriptome -l dothideomycetes_odb10 --out_path Transcripts/ -f -c 28
# Genes
